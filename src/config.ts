...
const envConfigSchema = z.object({
  ...
  llm: z.object({
    ...
    complex: z.object({
      model: z.string().default('claude-opus-4-6-20250514'),
      provider: z.string().default('anthropic'),
    }),
    tools: z.object({
      model: z.string().default('claude-haiku-4-5-20251001'),
    ...
    fallback: z.object({
      classifyModel: z.string().default('gemini-3-flash'),
      classifyProvider: z.string().default('google'),
      respondModel: z.string().default('gemini-3-flash'),
      respondProvider: z.string().default('google'),
      complexModel: z.string().default('gemini-3-pro'),
