...
export const instanceConfigSchema = z.object({
  ...
  llm: z.object({
    ...
    models: z.object({
      ...
      respond: z.object({
        provider: z.string().default('anthropic'),
        model: z.string().default('claude-sonnet-4-5-20241022'),
        maxInputTokens: z.number().default(8192),
        maxOutputTokens: z.number().default(2048),
      }).default({}),
      complex: z.object({
        provider: z.string().default('anthropic'),
        model: z.string().default('claude-opus-4-5-20250115'),
...
const envConfigSchema = z.object({
  ...
  llm: z.object({
    ...
    fallback: z.object({
      classifyModel: z.string().default('gemini-2.0-flash'),
      classifyProvider: z.string().default('google'),
      respondModel: z.string().default('gemini-2.0-flash'),
      respondProvider: z.string().default('google'),
      complexModel: z.string().default('gemini-2.0-pro'),
