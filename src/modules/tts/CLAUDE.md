...
- configSchema: TTS_GOOGLE_API_KEY, TTS_VOICE_LANGUAGE, TTS_VOICE_NAME, TTS_SPEAKING_RATE, TTS_PITCH, TTS_MAX_CHARS, TTS_ENABLED_CHANNELS, TTS_AUTO_FOR_AUDIO_INPUT, TTS_AUDIO_TO_AUDIO_FREQ, TTS_TEXT_TO_AUDIO_FREQ, TTS_MAX_DURATION
...
- `shouldAutoTTS(channel, inputType)` retorna true basado en frecuencia configurable (TTS_AUDIO_TO_AUDIO_FREQ para audio input, TTS_TEXT_TO_AUDIO_FREQ para texto). Probabilidad 0-100%.
