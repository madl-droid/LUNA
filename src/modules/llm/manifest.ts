...
const manifest: ModuleManifest = {
  ...
  configSchema: z.object({
    ...
    LLM_MAIN_MODEL: z.string().default('claude-sonnet-4-6-20260214'),
    LLM_COMPLEX_PROVIDER: z.string().default('anthropic'),
    LLM_COMPLEX_MODEL: z.string().default('claude-opus-4-6-20260210'),
    ...
    LLM_MEDIA_MODEL: z.string().default('gemini-2.5-flash'),
    ...
    LLM_COMPRESS_MODEL: z.string().default('claude-sonnet-4-6-20260214'),
    LLM_BATCH_PROVIDER: z.string().default('anthropic'),
    LLM_BATCH_MODEL: z.string().default('claude-sonnet-4-6-20260214'),
    ...
    LLM_KNOWLEDGE_MODEL: z.string().default('text-embedding-004'),

    // ── Task routing: downgrade (same provider, lesser model — empty = no downgrade) ──
    LLM_MAIN_DOWNGRADE_PROVIDER: z.string().default(''),
    LLM_MAIN_DOWNGRADE_MODEL: z.string().default(''),
    LLM_COMPLEX_DOWNGRADE_PROVIDER: z.string().default('anthropic'),
    LLM_COMPLEX_DOWNGRADE_MODEL: z.string().default('claude-sonnet-4-6-20260214'),
    LLM_MEDIA_DOWNGRADE_PROVIDER: z.string().default('google'),
    LLM_MEDIA_DOWNGRADE_MODEL: z.string().default('gemini-2.5-flash-lite'),
    ...
    LLM_MAIN_FALLBACK_MODEL: z.string().default('gemini-2.5-flash'),
    ...
    LLM_CRITICIZE_FALLBACK_MODEL: z.string().default('claude-sonnet-4-6-20260214'),
    LLM_MEDIA_FALLBACK_PROVIDER: z.string().default('anthropic'),
    LLM_MEDIA_FALLBACK_MODEL: z.string().default('claude-sonnet-4-6-20260214'),
    LLM_WEB_SEARCH_FALLBACK_PROVIDER: z.string().default('anthropic'),
    LLM_WEB_SEARCH_FALLBACK_MODEL: z.string().default('claude-sonnet-4-6-20260214'),
