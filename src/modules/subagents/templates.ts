...
const labels: Record<Lang, Record<string, string>> = {
  es: {
    ...
    descPlaceholder: 'Instrucciones para el agente de cuando y como debe usar este subagente...',
    enabled: 'Activo',
  ...
  en: {
    ...
    descPlaceholder: 'Instructions for the agent on when and how to use this subagent...',
    enabled: 'Active',
